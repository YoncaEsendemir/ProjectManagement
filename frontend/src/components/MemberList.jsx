          ...
          <div className='space-y-1.5 max-[80%]'>
            ...
            {/* Yetenekler */}
            {
              ...
              <div className="flex space-x-1 opacity-100 lg:opacity-0 group-hover:opacity-100 transition-opacity pt-1">
                <button onClick={()=>(member)} className='text-xs bg-slate-100 hover:bg-red-600 px-2 py-1 rounded transition'>
                  Düzenle
                </button>
                <button onClick={()=>onDelete(member.id)} className='text-xs bg-slate-100 hover:bg-red-600 px-2 py-1 rounded transition'>Sil</button>
              </div>
