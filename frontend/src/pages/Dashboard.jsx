        ...
        <div className='lg:col-span-2 flex flex-col space-y-6'>
            <div className='bg-slate-200/50 p-6 rounded-xl border border-slate-200 shadow-sm'>
                <div className='border-b border-slate-300 dark:border-slate-100 pb-3 mb-4'>
                    <h2 className='text-2xl font-semibold text-slate-900 dark:text-white/80'>Üye Listesi {members.length}</h2>
            ...
            <div className='bg-slate-200/50 p-6 rounded-xl border border-slate-200 shadow-sm'>
                <div className='border-b border-slate-300 dark:border-slate-100 pb-3 mb-4'>
                <h2 className='text-2xl font-semibold text-slate-900 dark:text-white/80'> Görev Listesi {tasks.length} </h2>
